...
function requireCollection () {
	if (hasRequiredCollection) return Collection_1;
...
var MultiValuedMap_1;
var hasRequiredMultiValuedMap;

function requireMultiValuedMap () {
	if (hasRequiredMultiValuedMap) return MultiValuedMap_1;
	hasRequiredMultiValuedMap = 1;

	const { ArrayCollection } = requireCollection();
	...
	MultiValuedMap_1 = MultiValuedMap;
	return MultiValuedMap_1;
}
...
var multivaluemap;
var hasRequiredMultivaluemap;

function requireMultivaluemap () {
	if (hasRequiredMultivaluemap) return multivaluemap;
	hasRequiredMultivaluemap = 1;

	const Collection = requireCollection();
	const MultiValueMap = requireMultiValuedMap();
...
var multivaluemapExports = requireMultivaluemap();
var index = /*@__PURE__*/getDefaultExportFromCjs(multivaluemapExports);
